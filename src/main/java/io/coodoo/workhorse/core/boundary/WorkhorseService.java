...
public class WorkhorseService {
     ...
     * @return {@link ExecutionStatusCounts}
     */
    public ExecutionStatusCounts getExecutionStatusCounts(Long jobId, LocalDateTime from) {
        return getExecutionStatusCounts(jobId, from, null);
    }
    ...
    public ExecutionStatusCounts getExecutionStatusCounts(Long jobId, LocalDateTime from, LocalDateTime to) {
        ...
        return workhorseController.getExecutionStatusCounts(jobId, from, to);
    }
