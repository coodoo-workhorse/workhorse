...
public class WorkhorseConfigControl {
     ...
     */
    // @Deprecated
    // public void initializeConfig(String timeZone, int jobQueuePollerInterval, int
    // jobQueuePusherPoll, Long jobQueueMax,
    // int jobQueueMin, PersistenceTyp persistenceTyp) {

    // WorkhorseConfig newWorkhorseConfig =
    // workhorseConfigControl.getWorkhorseConfig();
