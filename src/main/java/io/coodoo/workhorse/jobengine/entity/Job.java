...
public class Job extends BaseEntity {
   ...
   /**
    ...
    /**
     * If a job has the uniqueInqueue set <code>true</code>, 
     * Two or more job execution with the same parameters are not authorised
     */
    ...
    public String toString() {
        return "Job [Id="+ id +", description=" + description + ", name=" + name + ", parametersClassName=" + parametersClassName
                + ", schedule=" + schedule + ", status=" + status + ", threads=" + threads + ", workerClassName="
                + workerClassName + "]";
    }
