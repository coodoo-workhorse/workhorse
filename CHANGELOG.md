...
Workhorse gone wild and furious! It finally broke free from the chains of Java EE!

* Plain Java CDI
* Modular architecture (different persistences, REST-API, UI, ...)
* Core functionality and features doing the job using memory and pure strength
* Suitable for all kinds of Java environments (Wildfly, Tomcat, Quarkus, Spring, Plain Java, ...)

### BREAKING CHANGES

* Where to start?! Nearly everything...
